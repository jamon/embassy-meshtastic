...
/// Represents a parsed Meshtastic packet header (16 bytes)
...
pub struct MeshtasticHeader {
    ...
    pub flags: MeshtasticHeaderFlags,
...
pub struct MeshtasticHeaderFlags {
...
impl core::fmt::Display for MeshtasticHeader {
...
impl core::fmt::Display for MeshtasticHeaderFlags {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            f,
            "{}/{} {}{}",
...
#[cfg(feature = "defmt")]
impl defmt::Format for MeshtasticHeaderFlags {
...
#[cfg(feature = "defmt")]
impl defmt::Format for MeshtasticHeader {
    fn format(&self, fmt: defmt::Formatter) {
        defmt::write!(
            fmt,
            "{:08X} -> {:08X} [{}] {:08X} #{:02X} {:02X} {:02X}",
...
impl MeshtasticHeader {
    ...
    pub fn from_bytes(header_bytes: &[u8]) -> Option<Self> {
        ...
        Some(MeshtasticHeader {
            ...
            flags: MeshtasticHeaderFlags::from_raw(header_bytes[12]),
    ...
    /// Create an IV/nonce for Meshtastic packet encryption following the protocol specification
    ///
    /// Meshtastic IV format (16 bytes):
    ...
    ///
    /// This maintains compatibility with the Meshtastic protocol specification.
    ...
    /// Create an IV/nonce for Meshtastic packet encryption with explicit packet_id and from_node
    ///
    ...
    /// Create a new MeshtasticHeader with the given parameters
